...
def tools(kind):
 ...
 return ''
def section(s,n):
 h=f'<section class="section'+(' tint' if n%2 else '')+'"><div class="wrap"><div class="section-head reveal"><div><span class="section-number">{n:02d} / EXPLORE</span><h2>{s["title"]}</h2></div></div>'
 # The second half above must be interpolated after joining the class name.
