...
def tools(kind):
 ...
 return ''
def section(s,n):
 h='<section class="section'+(' tint' if n%2 else '')+f'"><div class="wrap"><div class="section-head reveal"><div><h2>{s["title"]}</h2></div></div>'
...
def build_page(p,index):
 ...
 out=f'<!doctype html>\n<html lang="en-AU"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{esc(p["label"])} | Mutual Futures</title><meta name="description" content="{esc(p["intro"],quote=True)}"><meta name="theme-color" content="#f5f7f8"><link rel="canonical" href="{base}{"" if home else slug+".html"}"><meta property="og:type" content="website"><meta property="og:site_name" content="Mutual Futures"><meta property="og:title" content="{esc(plain,quote=True)}"><meta property="og:description" content="{esc(p["intro"],quote=True)}"><meta property="og:image" content="{base+image(p["image"])}"><meta property="og:url" content="{base}{"" if home else slug+".html"}"><meta name="twitter:card" content="summary_large_image"><link rel="icon" type="image/png" href="assets/images/mutual-futures-icon-32.png"><link rel="apple-touch-icon" href="assets/images/mutual-futures-icon-192.png"><link rel="stylesheet" href="assets/style.css?v=20260924-upgrade"><script defer src="assets/app.js?v=20260924-upgrade"></script></head><body id="top" style="--accent:{accent}"><a class="skip" href="#main">Skip to content</a>'
 out+='<header class="site-head"><div class="wrap head-inner"><a class="brand" href="index.html#top"><img src="assets/images/mutual-futures-icon-192.png" alt="" width="44" height="44"><span>Mutual Futures<small>Strange but True</small></span></a><nav class="primary" aria-label="Primary">'
 for s,l in [('succession','Business handovers'),('workforce','Work & life'),('intelligence','Personal AI'),('resilience','Resilience'),('library','Library')]:out+=f'<a href="{s}.html"'+(' aria-current="page"' if s==slug else '')+'>'+l+'</a>'
 ...
 out+='<h1>'+p['title']+'</h1><p class="lede">'+esc(p['intro'])+'</p><div class="actions">'
 ...
 elif p.get('tool'):out+=link('#model','Read the model and try the tool','button primary-button')+link('sources.html','Follow the sources','button')
 else:out+=link('#chapter','Explore this chapter','button primary-button')+link('site-map.html','All chapters','button')
 out+='</div></div><div class="wrap hero-foot"><span>An idea from Minjerribah, open for discussion</span><a href="assets/asset-manifest.json" target="_blank" rel="noopener">AI concept artwork and credits ↗</a><span>September 2026</span></div></section><div class="intro-strip" id="chapter"><div class="wrap"><p><strong>An idea to explore together.</strong> Read the proposal, try the tools and follow the sources. No sign-up needed.</p><span class="tag proposal">Public proposal</span></div></div>'
 ...
 out+='<footer class="site-footer"><div class="wrap"><div class="footer-top"><div><a class="brand" href="index.html#top"><img src="assets/images/mutual-futures-icon-192.png" alt="" width="44" height="44"><span>Mutual Futures<small>A wider field of choice</small></span></a><p>Shared ownership, useful technology and more time for life. A proposal by Luke Nathan Hayes, open for discussion and development.</p></div><nav class="footer-links" aria-label="Workbench links"><h3>Explore the site</h3>'+link('site-map.html','Every chapter')+link('library.html','Document library')+link('sources.html','Sources and connections')+link('about.html','About and contact')+'</nav><nav class="footer-links" aria-label="Related project links"><h3>Related projects</h3>'+link('https://auraofintelligence.github.io/','Aura of Intelligence ↗')+link('https://auraofintelligence.github.io/strange-but-true/','Strange but True ↗')+link('https://auraofintelligence.github.io/GAJRA-earth-infinity/','GAJRA Earth ↗')+link(SITE['repo'],'GitHub repository ↗')+'</nav></div><div class="footer-bottom"><span>© 2026 Luke Nathan Hayes · '+link('licence.html','Strange But True Public Source Licence')+'</span><span>Tools run in your browser · No account · <button type="button" data-print class="print-button">Print this page</button></span></div></div></footer><a href="#top" class="to-top" aria-label="Back to top">↑</a></body></html>\n'
 return out
